  ...
  <form class="row g-3 needs-validation" id="form" novalidate>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <input required id="Fornec" type="text" required
    ...
    <div class="row">
      <div class="col-md-12">
        <label for="ObsRetErp" class="form-label">Observações Retorno Erp</label>
        <input disabled id="ObsRetErp" type="text" required
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
      </div>
    </div>
    ...
    <!-- Banco -->
    <div class="row" id="PagBanco" style="display: none;">
      <div class="col-md-12">
    ...
    <!-- Agencia/Conta -->
    <div class="row" id="PagBancoAge" style="display: none;">
      <div class="col-md-6">
    ...
    <!-- Chave PIX -->
    <div class="row" id="PagPix" style="display: none;">
      <div class="col-md-6">
    ...
    <div class="row" id="parcela1" style="display: flex;">
      ...
      <div class="col-md-3">
        ...
        <input disabled id="VlrParUm" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 1 -->
    <div class="row" id="parcela1Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolUm" class="form-label">Código Boleto 1</label>
        <input disabled id="CodBolUm" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <div class="row" id="parcela2" style="display: none;">
      <!--  <div class="col-md-3">
      ...
      <div class="col-md-3">
        ...
        <input disabled id="DescParDois" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParDois" class="form-label">Valor Parcela 2</label>
        <input disabled id="VlrParDois" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 2 -->
    <div class="row" id="parcela2Bol" style="display: none">
      <div class="col-md-12">
        <label for="CodBolDois" class="form-label">Código Boleto 2</label>
        <input disabled id="CodBolDois" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <div class="row" id="parcela3" style="display: none;">
      <!--<div class="col-md-3">
      ...
      <div class="col-md-3">
        ...
        <input disabled id="DescParTres" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParTres" class="form-label">Valor Parcela 3</label>
        <input disabled id="VlrParTres" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 3 -->
    <div class="row" id="parcela3Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolTres" class="form-label">Código Boleto 3</label>
        <input disabled id="CodBolTres" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 4---------------------------------------------------------------->
    <div class="row" id="parcela4" style="display: none;">
      <div class="col-md-3">
        <label for="DescParQuatro" class="form-label">Descrição Parcela 4</label>
        <input disabled id="DescParQuatro" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
    ...
    <!-- Código Boleto 4 -->
    <div class="row" id="parcela4Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolQuatro" class="form-label">Código Boleto 4</label>
        <input disabled id="CodBolQuatro" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 5---------------------------------------------------------------->
    <div class="row" id="parcela5" style="display: none;">
      <div class="col-md-3">
        <label for="DescParCinco" class="form-label">Descrição Parcela 5</label>
        <input disabled id="DescParCinco" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
    ...
    <!-- Código Boleto 5 -->
    <div class="row" id="parcela5Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolCinco" class="form-label">Código Boleto 5</label>
        <input disabled id="CodBolCinco" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 6---------------------------------------------------------------->
    <div class="row" id="parcela6" style="display: none;">
      <div class="col-md-3">
        <label for="DescParSeis" class="form-label">Descrição Parcela 6</label>
        <input disabled id="DescParSeis" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParSeis" class="form-label">Valor Parcela 6</label>
        <input disabled id="VlrParSeis" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 6 -->
    <div class="row" id="parcela6Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolSeis" class="form-label">Código Boleto 6</label>
        <input disabled id="CodBolSeis" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 7---------------------------------------------------------------->
    <div class="row" id="parcela7" style="display: none;">
      <div class="col-md-3">
        <label for="DescParSete" class="form-label">Descrição Parcela 7</label>
        <input disabled id="DescParSete" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParSete" class="form-label">Valor Parcela 7</label>
        <input disabled id="VlrParSete" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 7 -->
    <div class="row" id="parcela7Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolSete" class="form-label">Código Boleto 7</label>
        <input disabled id="CodBolSete" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 8---------------------------------------------------------------->
    <div class="row" id="parcela8" style="display: none;">
      <div class="col-md-3">
        <label for="DescParOito" class="form-label">Descrição Parcela 8</label>
        <input disabled id="DescParOito" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParOito" class="form-label">Valor Parcela 8</label>
        <input disabled id="VlrParOito" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 8 -->
    <div class="row" id="parcela8Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolOito" class="form-label">Código Boleto 8</label>
        <input disabled id="CodBolOito" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 9---------------------------------------------------------------->
    <div class="row" id="parcela9" style="display: none;">
      <div class="col-md-3">
        <label for="DescParNove" class="form-label">Descrição Parcela 9</label>
        <input disabled id="DescParNove" type="text" oninput="javascript:calculaTotal();" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParNove" class="form-label">Valor Parcela 9</label>
        <input disabled id="VlrParNove" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 9 -->
    <div class="row" id="parcela9Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolNove" class="form-label">Código Boleto 9</label>
        <input disabled id="CodBolNove" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 10---------------------------------------------------------------->
    <div class="row" id="parcela10" style="display: none;">
      <div class="col-md-3">
        <label for="DescParDez" class="form-label">Descrição Parcela 10</label>
        <input disabled id="DescParDez" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParDez" class="form-label">Valor Parcela 10</label>
        <input disabled id="VlrParDez" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 10 -->
    <div class="row" id="parcela10Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolDez" class="form-label">Código Boleto 10</label>
        <input disabled id="CodBolDez" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 11---------------------------------------------------------------->
    <div class="row" id="parcela11" style="display: none;">
      <div class="col-md-3">
        <label for="DescParOnze" class="form-label">Descrição Parcela 11</label>
        <input disabled id="DescParOnze" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParOnze" class="form-label">Valor Parcela 11</label>
        <input disabled id="VlrParOnze" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 11 -->
    <div class="row" id="parcela11Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolOnze" class="form-label">Código Boleto 11</label>
        <input disabled id="CodBolOnze" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
    ...
    <!----------------------------------------------------------------Parcela 12---------------------------------------------------------------->
    <div class="row" id="parcela12" style="display: none;">
      <div class="col-md-3">
        <label for="DescParDoze" class="form-label">Descrição Parcela 12</label>
        <input disabled id="DescParDoze" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
      <div class="col-md-3">
        <label for="VlrParDoze" class="form-label">Valor Parcela 12</label>
        <input disabled id="VlrParDoze" type="text" oninput="ExibeBoleto()" onKeyUp="mascaraMoeda(this, event)" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required"
    ...
    <!-- Código Boleto 12 -->
    <div class="row" id="parcela12Bol" style="display: none;">
      <div class="col-md-12">
        <label for="CodBolDoze" class="form-label">Código Boleto 12</label>
        <input disabled id="CodBolDoze" type="text" value=""
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    </div>
